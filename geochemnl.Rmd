...
Small usage example of the Dutch Geochemical Soil Atlas package

The data of the atlas is part of the DGSA package. Execute the following code to load it (using the devtools package):
